...
1. Instal dependensi: `pip install -r D:\AryokPunya\Magang\sitegen\.agents\skills\sitegen\intake\scripts\requirements.txt`
2. Eksekusi script: `python D:\AryokPunya\Magang\sitegen\.agents\skills\sitegen\intake\scripts\extract.py <path_ke_compro.pdf>`
