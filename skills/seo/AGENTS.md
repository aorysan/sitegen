...
1. **Audit Mutlak Terhadap DOM:**
   ...
   - Setiap temuan foto yang lumpuh (404), memakai placeholder fiktif, atau kehilangan atribut SEO wajib dicatat ke dalam `landings/<brand>/reports/SEO-AUDIT.md` sebagai cacat kritis yang menahan kelayakan rilis web.
