...
1. **User Approval Wajib:**
   - Setelah agen mengusulkan pendekatan desain dan user menyetujui, agen WAJIB menulis `user_preferences.md` kemudian BERHENTI MENGEKSEKUSI TOOL APA PUN DAN AKHIRI GILIRAN (END TURN) serta mengembalikan kontrol ke master orchestrator. Tunggu konfirmasi persetujuan dari user secara eksplisit sebelum melanjutkan ke tahap berikutnya. Dilarang memanfaatkan momentum untuk meneruskan eksekusi secara mandiri.
