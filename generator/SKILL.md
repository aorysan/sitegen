...
# Full Website Generator (Sitegen V3.4)
...
2. Biarkan dev server berjalan, lalu **PANGGIL SKILL `debug`** untuk mengeksekusi iterasi pengecekan visual (Puppeteer) dan performa (Lighthouse).
